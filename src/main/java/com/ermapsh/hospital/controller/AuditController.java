...
public class AuditController {
    ...
    @GetMapping(path = "/post/{postId}") // revision api for admin to understand who done what
    public List<PostEntity> getPostRevision(@PathVariable Long postId){
        ...
        return revisions    .
                stream().
                map(revisionNumber->reader.find(PostEntity.class, postId, revisionNumber)).collect(Collectors.toList());
